# Multi-process container: Flask backend (with Node/Puppeteer worker) + Next.js frontend
...
RUN apt-get update && apt-get install -y \
    ...
    libfontconfig1 libgcc1 libglib2.0-0 libgtk-3-0 \
